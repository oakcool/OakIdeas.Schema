...
using OakIdeas.Schema.Core.Intangibles.Enumerations.QualitativeValues;
...
namespace OakIdeas.Schema.Core.Products
{
    ...
    /// </summary>
    /// <see cref="http://www.schema.org/Vehicle"/>
    public class Vehicle: Product
    {
        ...
        /// </summary>
        public DateTime DateVehicleFirstRegistred { get; set; }
        /// <summary>
        /// The drive wheel configuration, i.e. which roadwheels will receive torque from the vehicle's engine via the drivetrain.
        /// </summary>
        public DriveWheelConfiguration DriveWheelConfiguration { get; set; }
        /// <summary>
        ...
        /// </summary>
        public QuantitativeValue MileFromOdometer { get; set; }
        /// <summary>
        ...
        /// </summary>
        public QuantitativeValue VehicleSeatingCapacity { get; set; }
        /// <summary>
        /// The type of component used for transmitting the power from a rotating power source to the wheels or other relevant component(s) ("gearbox" for cars).
        /// </summary>
        public QualitativeValue VehicleTransmission { get; set; }
    }
}
