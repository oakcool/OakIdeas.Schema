...
using OakIdeas.Schema.Core.Intangibles.Enumerations.ItemAvailabilities;
using OakIdeas.Schema.Core.Intangibles.Enumerations.PaymentMethods;
using OakIdeas.Schema.Core.Intangibles.StructuredValues;
using OakIdeas.Schema.Core.Intangibles.StructuredValues.PriceSpecifications;
